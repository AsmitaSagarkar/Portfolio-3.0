    ...
    <section id="hero" className="flex flex-col items-center justify-center min-h-[90vh] px-4 text-center">
      <MotionDiv className="max-w-4xl" transition={{ staggerChildren: 0.1 }}>
        ...
        <motion.div 
          ...
          className="mx-auto rounded-full border-4 border-primary-accent w-40 h-40 flex items-center justify-center text-5xl font-bold text-primary-accent shadow-2xl mb-8"
        >
          AS
        </motion.div>
